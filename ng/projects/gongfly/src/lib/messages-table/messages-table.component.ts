...
export class MessagesTableComponent implements OnInit {
  ...
  setEditorRouterOutlet(messageID: number) {
    this.router.navigate([{
      outlets: {
        github_com_fullstack_lang_gongfly_go_editor: ["github_com_fullstack_lang_gongfly_go-" + "message-detail", messageID]
      }
    }]);
  }

  // set presentation outlet
  setPresentationRouterOutlet(messageID: number) {
    this.router.navigate([{
      outlets: {
        github_com_fullstack_lang_gongfly_go_presentation: ["github_com_fullstack_lang_gongfly_go-" + "message-presentation", messageID]
      }
    }]);
  }

...
import { CivilianAirportAPI } from './civilianairport-api';
...
export class CivilianAirportService {
  ...
  private civilianairportsUrl = 'http://localhost:8080/api/github.com/fullstack-lang/gongfly/go/v1/civilianairports';

...
var PropagationTestCase1 = (&models.Satellite{
	...
	Name:  "Sat 1",
}).InitFromTLE().StageCopy().Register()

var PropagationTestCase4 = (&models.Satellite{
...
var PropagationTestCase2 = (&models.Satellite{
...
var PropagationTestCase3 = (&models.Satellite{
...
var InternationalSpaceStation = (&models.Satellite{
	Line1: "1 25544U 98067A   08264.51782528 -.00002182  00000-0 -11606-4 0  2927",
	Line2: "2 25544  51.6416 247.4627 0006703 130.5360 325.0288 15.72125391563537",
	Name:  "ISS",
}).InitFromTLE().StageCopy().Register()

var PropagationTestCase5 = (&models.Satellite{
	Line1: "1 04632U 70093B   04031.91070959 -.00000084  00000-0  10000-3 0  9955",
	Line2: "2 04632  11.4628 273.1101 1450506 207.6000 143.9350  1.20231981 44145",
	Name:  "Sat 6",
}).InitFromTLE().StageCopy().Register()

var PropagationTestCase6 = (&models.Satellite{
...
var PropagationTestCase7 = (&models.Satellite{
	Line1: "1 06251U 62025E   06176.82412014  .00008885  00000-0  12808-3 0  3985",
	Line2: "2 06251  58.0579  54.0425 0030035 139.1568 221.1854 15.56387291  6774",
	Name:  "Sat 7",
}).InitFromTLE().StageCopy().Register()

var PropagationTestCase8 = (&models.Satellite{

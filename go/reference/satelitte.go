...
func LoadSatellites(stage *models.StageStruct, engine *gongsim_models.Engine) {
	Sat1 = (&models.Satellite{
		Line1: "1 00005U 58002B   00179.78495062  .00000023  00000-0  28098-4 0  4753",
		Line2: "2 00005  34.2682 348.7242 1859667 331.7664  19.3264 10.82419157413667",
		Name:  "Sat 1",
	}).InitFromTLE().Stage(stage).Register(engine)

	Sat2 = (&models.Satellite{
	...
	ISS = (&models.Satellite{
		Line1: "1 25544U 98067A   08264.51782528 -.00002182  00000-0 -11606-4 0  2927",
		Line2: "2 25544  51.6416 247.4627 0006703 130.5360 325.0288 15.72125391563537",
		Name:  "ISS",
	}).InitFromTLE().Stage(stage).Register(engine)

	Sat5 = (&models.Satellite{
		Line1: "1 04632U 70093B   04031.91070959 -.00000084  00000-0  10000-3 0  9955",
		Line2: "2 04632  11.4628 273.1101 1450506 207.6000 143.9350  1.20231981 44145",
		Name:  "Sat 5",
	}).InitFromTLE().Stage(stage).Register(engine)

	Sat6 = (&models.Satellite{
	...
	Sat7 = (&models.Satellite{
		Line1: "1 06251U 62025E   06176.82412014  .00008885  00000-0  12808-3 0  3985",
		Line2: "2 06251  58.0579  54.0425 0030035 139.1568 221.1854 15.56387291  6774",
		Name:  "Sat 7",
	}).InitFromTLE().Stage(stage).Register(engine)

	Sat8 = (&models.Satellite{

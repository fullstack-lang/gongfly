...
import (
	...
	"github.com/fullstack-lang/gongfly"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongfly.NgDistNg, "ng-github.com-fullstack-lang-gongfly/dist/ng-github.com-fullstack-lang-gongfly/browser")))

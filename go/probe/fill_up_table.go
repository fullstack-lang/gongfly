...
func fillUpTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	case *models.CivilianAirport:
		fillUpTable[models.CivilianAirport](probe)
	case *models.Liner:
		fillUpTable[models.Liner](probe)
	case *models.Message:
		fillUpTable[models.Message](probe)
	case *models.OpsLine:
		fillUpTable[models.OpsLine](probe)
	case *models.Radar:
		fillUpTable[models.Radar](probe)
	case *models.Satellite:
		fillUpTable[models.Satellite](probe)
	case *models.Scenario:
		fillUpTable[models.Scenario](probe)
	default:

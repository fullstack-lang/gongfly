...
func fillUpTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	case *models.CivilianAirport:
		fillUpTable[models.CivilianAirport](playground)
	case *models.Liner:
		fillUpTable[models.Liner](playground)
	case *models.Message:
		fillUpTable[models.Message](playground)
	case *models.OpsLine:
		fillUpTable[models.OpsLine](playground)
	case *models.Radar:
		fillUpTable[models.Radar](playground)
	case *models.Satellite:
		fillUpTable[models.Satellite](playground)
	case *models.Scenario:
		fillUpTable[models.Scenario](playground)
	default:

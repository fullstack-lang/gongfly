...
func SerializeStage(filename string) {
	...
	{
		// insertion point
		SerializeExcelize[CivilianAirport](f)
		SerializeExcelize[Liner](f)
		SerializeExcelize[Message](f)
		SerializeExcelize[OpsLine](f)
		SerializeExcelize[Radar](f)
		SerializeExcelize[Satellite](f)
		SerializeExcelize[Scenario](f)
	}

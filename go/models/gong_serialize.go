...
func SerializeStage(stage *StageStruct, filename string) {
	...
	{
		// insertion point
		SerializeExcelize[CivilianAirport](stage, f)
		SerializeExcelize[Liner](stage, f)
		SerializeExcelize[Message](stage, f)
		SerializeExcelize[OpsLine](stage, f)
		SerializeExcelize[Radar](stage, f)
		SerializeExcelize[Satellite](stage, f)
		SerializeExcelize[Scenario](stage, f)
	}

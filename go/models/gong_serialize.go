...
func SerializeStage(stage *StageStruct, filename string) {
	...
	{
		// insertion point
		SerializeExcelizePointerToGongstruct[*CivilianAirport](stage, f)
		SerializeExcelizePointerToGongstruct[*Liner](stage, f)
		SerializeExcelizePointerToGongstruct[*Message](stage, f)
		SerializeExcelizePointerToGongstruct[*OpsLine](stage, f)
		SerializeExcelizePointerToGongstruct[*Radar](stage, f)
		SerializeExcelizePointerToGongstruct[*Satellite](stage, f)
		SerializeExcelizePointerToGongstruct[*Scenario](stage, f)
	}
